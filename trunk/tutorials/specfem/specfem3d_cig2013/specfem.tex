...
\item The kernel files can be visualized with \paraview. First compile the program that can combine selected slices of kernels and produce vtk files for \verb+Parview+. In the \specfem\ directory, \blue{is cd bin really necessary?}
