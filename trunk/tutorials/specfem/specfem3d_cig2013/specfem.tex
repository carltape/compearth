...
\documentclass[10pt,titlepage,fleqn,letterpaper]{article}
...
\item The generate databases takes about xx minutes.
\item The solver takes about xx minutes.
\end{itemize}
%
[ADD SOMETHING ABOUT SEISMOGRAMS LOOKING BAD, SINCE THE HALF DURATION IS ZERO SECONDS.]
