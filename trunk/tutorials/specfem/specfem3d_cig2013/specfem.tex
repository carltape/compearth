...
\end{lstlisting}
%
Then \verb+File --> Open+, and select all four \path{vs*vtk} files. When you are done, be sure to unload the \paraview\ module, since here it was compiled with \verb+gnu+, which conflicts with the \verb+portland+ we are using.
%
\begin{lstlisting}
