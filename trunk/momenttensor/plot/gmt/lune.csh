...
30.0000 54.7356 14 0 1 CM -
EOF
psxy ./dfiles//beachpts_Ford2009_points.dat -N -Sc8p -W0.5p,0/0/0 -G0/0/0 -J -R -K -O -V >>lune_hammer_iplot1.ps
...
psxy -N -Sc8p -W0.5p,0/0/0 -G0/0/0 -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
0 1.2
EOF
pstext -N -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
 0.2 1.2 12 0 1 LM Ford2009 (n=32)
EOF
psxy -N -Sc8p -W0.5p,0/0/0 -G255/165/0 -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
0 0.9
EOF
pstext -N -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
 0.2 0.9 12 0 1 LM Foulger2004 (n=26)
EOF
psxy -N -Sc8p -W0.5p,0/0/0 -G255/0/0 -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
0 0.6
EOF
pstext -N -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
 0.2 0.6 12 0 1 LM Minson2007 (n=18)
EOF
psxy -N -Sc8p -W0.5p,0/0/0 -G50/205/50 -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
0 0.3
EOF
pstext -N -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
 0.2 0.3 12 0 1 LM Walter2009 (n=13)
EOF
psxy -N -Sc8p -W0.5p,0/0/0 -G160/32/240 -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
0 0
EOF
pstext -N -R0/1/0/1 -JX1i -Xa3.5 -Ya6 -K -O -V >>lune_hammer_iplot1.ps<<EOF
 0.2 0 12 0 1 LM Walter2010 (n=14)
EOF
