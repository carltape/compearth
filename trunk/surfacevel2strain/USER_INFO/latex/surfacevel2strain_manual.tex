...
%
%   Notes on converting discrete GPS velocity fields to continuous fields, and then strain rates.
% 
%=====================================================%
...
%
\noindent
The full output (and input) is shown below. This will also generate \refFigab{fig:2D_A5}{fig:2D_A7}, among many more (\refSec{sec:surfacevel2strain}).
%
%\small
\begin{spacing}{1.0}
\begin{verbatim}
