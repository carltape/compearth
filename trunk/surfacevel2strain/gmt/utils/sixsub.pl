...
$xtick1 = 2; $xtick2 = 1.0; $wid = 2.0;
$ytick1 = 1; $ytick2 = $xtick2;
$origin = "-X0.75 -Y8.75";
$xlegend = -0.1; $ylegend = -0.6;
...
$Bscale_strain  = sprintf("-B%2.2f:\"Strain rate, 10\@+%2.2i\@+ yr\@+-1\@+\": -Ef10p",$cmaxstrain*0.5,$cpwr3);
$Bscale_rot    = sprintf("-B%2.2f:\"Rotation rate, 10\@+%2.2i\@+ rad/yr\": -Ef10p",$cmaxrot*0.5,$cpwr4);
$Bscale_dilat  = sprintf("-B%2.2f:\"Dilatation rate, 10\@+%2.2i\@+ yr\@+-1\@+\": -E10p",$cmaxdilat,$cpwr2);
...
$x_title = 0.5; $z_title = 0.9; $z_title2 = 0.88;
$J1 = "-JM${wid}i";
...
$Bscale  = sprintf("-B%2.2f:\" \": -E10p",$cmaxdilat);
$B = $B0."WESn";
...
$Bscale  = sprintf("-B%2.2f:\"  \": -Ef10p",$cmaxstrain*0.5);
$B = $B0."weSn";
...
$Bscale  = sprintf("-B%2.2f:\"  \": -Ef10p",$cmaxrot*0.5);
...
for ($w = 1; $w <= 3; $w = $w+1) {
  ...
  if ($w==1) {
    ...
    #$title0 = sprintf("(e)  Rotation, |w\@-s\@-|",$cpwr4);
    $title0 = sprintf("(e)  |w\@-s\@-|, 10\@+%i\@+ rad/yr",$cpwr4);
    $B = $B0."WESn";
    $shift = $shift1;
  } elsif ($w==3) {
    #$title0 = sprintf("(f)  Rotation, |w\@-t\@-|",$cpwr4);
    $title0 = sprintf("(f)  |w\@-t\@-|, 10\@+%i\@+ rad/yr",$cpwr4);
    $B = $B0."weSn";
    $shift = $shift1;
  }
