...
fprintf(fid,'    up-south-east or r-t-p, where r=up, t=theta=south, p=phi=east.\n');
fprintf(fid,'    Mij are listed in order of the diagonal entries (Mrr, Mtt, Mpp), followed by the off-diagonal entries.\n');
fprintf(fid,'Also shown are other quantities derived from Mij;\n');
fprintf(fid,'   these entries are NOT listed with the highest precision.\n');
...
fprintf(fid,'These angles are not necessarily the fault plane, which could be the auxiliary plane.\n');
...
fprintf(fid,'The moment tensor source type is represented by lune longitude (gamma)\n');
fprintf(fid,'    and lune latitude (delta) (Tape and Tape, 2012, GJI).\n');
fprintf(fid,'COLUMNS\n');
