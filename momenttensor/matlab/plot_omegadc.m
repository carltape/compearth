function [N,Nplot,centers] = plot_omegadc(omega,nbin)
%PLOT_OMEGADC plot a distribution of omega angles (compared with DC distribution)
%
% INPUT
%   omega   angle between moment tensors, degrees
%
% see also plot_xi0.m, plot_omega.m
%
...
[p,t] = omegadcpdf(nbin);     % homogeneous PDF
